...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName("term").setDescription("Term to search for").setRequired(
        true,
      )
    ),
  ...
  execute: async (interaction) => {
    ...
    try {
      ...
      const urbanEmbed = new EmbedBuilder()
        ...
        .addFields(
          { name: "Definition", value: definition.definition.slice(0, 1024) },
          { name: "Example", value: definition.example.slice(0, 1024) },
        )
        .setFooter({
